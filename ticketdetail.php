        ...
        <div class="row ">
            <div class="col-7 ">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 col-6 ">
                        <h5 class="p-2 ">Lorem ipusm</h5>
                        <h5 class="p-2">Medium</h5>
                        <h5 class="p-2">open</h5>
            ...
            <div class="col-5 ">
                ...
                <div class="mb-4">
                    ...
                    <p >Assignee: <i class="bi bi-arrow-left-right" style="padding-left: 250px; "></i><i class="bi bi-pencil"  style="padding-left: 20px;"></i> </p>
                ...
                <div class="mb-4">
                    ...
                    <h6>Created :</h6>
                    <h6>3/27/2022, 11:20 AM</h6>
                    <h6>Updated :</h6>
                    <h6>3/28/2022, 01:50 PM</h6>
                    <h6>Solved:</h6>
