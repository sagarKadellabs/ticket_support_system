...
include 'sidebar.php';
?>
<form  action="createclientdb.php" method="post" style="padding:10px; margin-top:100px; margin-left:auto;">
...
<div class="row mb-3 mt-3">
  <div class="col">
    ...
    <input type="text" class="form-control form-boxes" 
      placeholder=" Full Name" name="users_name" required>
  </div>
  <div class="col">
...
<div class="row mb-3 mt-3">
  ...
  <?php
                     $sql= "SELECT * from roles join users 
  ...
  <div class="col" >
    ...
    <select class="form-select form-boxes" name="role" aria-label="Default select example">
      ...
      <?php
                        ...
                        ?>
      <option value="1"><?=$row['roles_name']?></option>
      <?php
                        }
                        ?>
    </select>
  ...
  <div class="col">
    ...
    <select class="form-select form-boxes" aria-label="Default select example" >
      ...
      <?php
                        ...
                        ?>
      <option value="1"><?=$row['position_name']?></option>
      <?php
                        }
                        ?>
    </select>
...
<button type="submit" name="create" class="btn" style="background-color:
